...
public class JwtUtils {
    private static final String SIGN_KEY = SystemConstants.JWT_SIGN_KEY;
    private static final long DEFAULT_EXPIRE = SystemConstants.JWT_DEFAULT_EXPIRE_TIME; // 12小时
