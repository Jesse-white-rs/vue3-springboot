...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role>
    ...
    public ResultResponse addRole(Role role) {
        ...
        if (roleMapper.insert(role) == SystemConstants.DB_OPERATION_FAILED){
    ...
    public ResultResponse deleteRole(Integer id) {
        if (roleMapper.deleteById(id) == SystemConstants.DB_OPERATION_FAILED){
    ...
    public ResultResponse updateRole(Role role) {
        if (roleMapper.updateById(role) == SystemConstants.DB_OPERATION_FAILED){
