...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu>
    ...
    public ResultResponse deletePermissions(Integer[] ids) {
        ...
        if (menuMapper.deleteBatchIds(Arrays.asList(ids)) == SystemConstants.DB_OPERATION_FAILED){
    ...
    public ResultResponse addPermissions(Menu menu) {
        ...
        if (menuMapper.insert(menu) == SystemConstants.DB_OPERATION_FAILED){
    ...
    public ResultResponse updatePermissions(Menu menu) {
        ...
        if (menuMapper.updateById(menu) == SystemConstants.DB_OPERATION_FAILED){
