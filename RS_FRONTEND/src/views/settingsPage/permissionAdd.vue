        ...
        <div v-show="props.visible" class="modal-container" @click.stop>
          <div class="modal-content-wrapper">
            ...
            <div class="modal-content">
              <el-form ref="formRef" :model="store.permissionAddFormData" :rules="store.PERMISSION_ADD_FORM_RULES" label-width="80px">
                <el-form-item label="权限名" prop="mName">
                  <el-input v-model="store.permissionAddFormData.mName" />
                </el-form-item>
                <el-form-item label="地址值" prop="mUrl">
                  <el-input v-model="store.permissionAddFormData.mUrl" />
                </el-form-item>
                <el-form-item label="权限标志" prop="mSign">
                  <el-input v-model="store.permissionAddFormData.mSign" />
                </el-form-item>
              </el-form>
            </div>
