            ...
            <div class="modal-content">
              ...
              >
                <el-form-item label="标题" prop="header">
                  <el-input
                    v-model="noticeEditFormData.header"
                    placeholder="请输入标题"
                    size="large"
                    class="ios-input"
                  />
                ...
                <el-form-item label="作者" prop="author">
                  <el-input
                    v-model="noticeEditFormData.author"
                    placeholder="请输入作者"
                    size="large"
                    class="ios-input"
                  />
                ...
                <el-form-item label="状态" prop="status">
                  <el-select
                    v-model="noticeEditFormData.status"
                    placeholder="请选择状态"
                    size="large"
                    class="ios-select"
                ...
                <el-form-item label="内容" prop="content">
                  <el-input
                    v-model="noticeEditFormData.content"
                    type="textarea"
                    placeholder="请输入公告内容"
...
const handleSubmit = async () => {
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      await store.updateData(noticeEditFormData.value);
      formRef.value?.resetFields();
      emit('update:visible');
    }
  });
