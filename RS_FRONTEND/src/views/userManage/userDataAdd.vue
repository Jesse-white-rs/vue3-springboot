        ...
        <div v-show="props.visible" class="modal-container" @click.stop>
          <div class="modal-content-wrapper">
            ...
            <div class="modal-content">
              ...
              <el-form :model="store.userAddFormData" :rules="store.USERADD_FORM_RULES" label-width="80px">
                <el-form-item label="姓名" prop="eName">
                  <el-input v-model="store.userAddFormData.emp.eName" />
                </el-form-item>
                <el-form-item label="账号" prop="eUsername">
                  <el-input v-model="store.userAddFormData.emp.eUsername" />
                </el-form-item>
                <el-form-item label="密码" prop="ePassword">
                  <el-input v-model="store.userAddFormData.emp.ePassword" type="password" show-password />
                </el-form-item>
                <el-form-item label="手机号" prop="ePhone">
                  <el-input v-model="store.userAddFormData.emp.ePhone" />
                </el-form-item>
                <el-form-item label="证件号" prop="eId">
                  <el-input v-model="store.userAddFormData.emp.eId" />
                </el-form-item>
                <el-form-item label="年龄" prop="eAge">
                  <el-input v-model="store.userAddFormData.emp.eAge" />
                </el-form-item>
                <el-form-item label="性别" prop="eGender">
                  <el-radio-group v-model="store.userAddFormData.emp.eGender">
                    <el-radio value="1">男</el-radio>
                    <el-radio value="0">女</el-radio>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="状态" prop="eIsenabled">
                  <el-radio-group v-model="store.userAddFormData.emp.eIsenabled">
                    <el-radio value="1">启用</el-radio>
                    <el-radio value="0">禁用</el-radio>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="部门" prop="eDeptid">
                  <el-select v-model="store.userAddFormData.emp.eDeptid" placeholder="请选择部门" popper-style="z-index: 3100">
                    <el-option v-for="item in deptStore.tableData" :key="item.id" :value="item.id" :label="item.dName" />
                  </el-select>
                </el-form-item>
                <el-form-item label="角色" prop="rId">
                  <el-select v-model="store.userAddFormData.role.rId" placeholder="请选择角色" popper-style="z-index: 3100">
            ...
            <div class="modal-footer">
              <div class="form-actions">
                ...
                <button type="button" class="ios-btn primary" @click="handleConfirm">确认添加</button>
              </div>
            </div>
          </div>
        </div>
