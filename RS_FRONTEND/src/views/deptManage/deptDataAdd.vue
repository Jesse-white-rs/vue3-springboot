        ...
        <div v-show="props.visible" class="modal-container" @click.stop>
          <div class="modal-content-wrapper">
            ...
            <div class="modal-content">
              ...
              <el-form ref="formRef" :model="store.deptAddFormData" :rules="store.DEPT_FORM_RULES" label-width="80px">
                <el-form-item label="部门名" prop="dName">
                  <el-input v-model="store.deptAddFormData.dName" placeholder="请输入部门名称" />
                </el-form-item>
              </el-form>
            </div>
...
watch(() => props.visible, (visible) => {
  if (visible) {
    store.deptAddFormData = { dName: '', dAvatarpath: '' };
    store.avatarUrl = '';
